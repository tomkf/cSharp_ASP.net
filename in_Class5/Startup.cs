...
namespace in_Class5
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //here is how to read config sdettings, will grab this from the app.settings.json
            var connection = Configuration.GetConnectionString("PortfolioConnection");

            var foodConnection = Configuration.GetConnectionString("FoodStoreConnection");
